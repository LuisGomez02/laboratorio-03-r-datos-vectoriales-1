...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Esperanza de vida de los países de Centroamérica") +
  xlab("Países de centroamérica") + 
...
```{r}
plot(centro_america["lifeExp"], main= "Esperanza de vida en los países de Centroamérica")
```
...
```{r}
centro_america_expvida =world[(world$name_long == "Belize" |
                       world$name_long == "Guatemala" |
                       world$name_long == "Honduras" |
                       world$name_long == "El Salvador" |
                       world$name_long == "Nicaragua" |
                       ...
                       world$name_long == "Panama")
                       & world$lifeExp >=74, ]
plot(centro_america_expvida ["lifeExp"], main= "Mapa de la Esperanza de vida mayor o igual a 74 años en Centroamérica")
```